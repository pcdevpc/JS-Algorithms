...
function selectionSortTests() {
  console.assert(
    JSON.stringify(selectionSort([6, 8, 14, 17, 23])) ==
      JSON.stringify([6, 8, 14, 17, 23]),
    "Selection sort Sorted Array"
  );
  console.assert(
    JSON.stringify(selectionSort([17, 23, 14, 6, 8])) ==
      JSON.stringify([6, 8, 14, 17, 23]),
...
function bubbleSortTests() {
  console.assert(
    JSON.stringify(bubbleSort([6, 8, 14, 17, 23])) ==
      JSON.stringify([6, 8, 14, 17, 23]),
    "Bubble sort Sorted Array"
  );
  console.assert(
    JSON.stringify(bubbleSort([17, 23, 14, 6, 8])) ==
      JSON.stringify([6, 8, 14, 17, 23]),
...
function insertionSortTests() {
  ...
  console.assert(
    JSON.stringify(insertionSort([17, 23, 14, 6, 8])) ==
      JSON.stringify([6, 8, 14, 17, 23]),
